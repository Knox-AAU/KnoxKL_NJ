...
class Test:
    ...
    def test_expected_three_arguments(self):
        ...
        parsed = parse_args(['-v', '-l', '-m', 'md'], parser=self.parser)
        assert str(parsed) == expected
