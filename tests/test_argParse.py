...
class Test:
    ...
    def test_expected_verb_short2(self):
        expected = "Namespace(debug=False, model='lg', verb='warning')"
        parsed = parse_args(['-v', 'warning'], parser=self.parser)
        assert str(parsed) == expected

    def test_expected_verb_short3(self):
        expected = "Namespace(debug=False, model='lg', verb='error')"
    ...
    def test_expected_debug_short(self):
        expected = "Namespace(debug=True, model='lg', verb='info')"
