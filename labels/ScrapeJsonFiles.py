...
def scrape():
    ...
    py = glob.glob(r'C:\Users\skyri\Desktop\Software\P5-Project\labels\rawfiles\2020-10-05_aalbor*')

    with open(r'C:\Users\skyri\Desktop\Software\P5-Project\labels\output\rawtext.txt', 'w', encoding='utf-8') as target:
